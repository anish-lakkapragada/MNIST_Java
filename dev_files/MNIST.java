...
public class MNIST  {
    ...
    public static int numData = 1500; //forward and back pass would hapepn quick iwth 500, 100, 32, 16, 50, 0.0004
    ...
    public static double learningRate = 0.0005; //working 0.0001 with 200, 4, 2, 100, 1000 config
    public static double biasLearningRate = 0.002 ;
    public static double leaking = 0.2;
    ...
    public static double momentum = 0.05;
    public static double biasMomentum = 0.1;
