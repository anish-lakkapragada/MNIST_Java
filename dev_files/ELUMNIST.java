...
public class ELUMNIST  {
    ...
    public static int numData = 500; //forward and back pass would hapepn quick iwth 500, 100, 32, 16, 50, 0.0004
    public static int numVal = 50;
    ...
    public static boolean nesterov = true;
    ...
    public static void weightInit() {
        ...
        for (int feature = 0; feature < x_train.get(0).size(); feature++) {
            ...
            for (int n1 = 0; n1 < numNeurons1;n1++) {
                ...
                featureToLayer.add(rnd.nextDouble() * 0.01);
                v1.add(0.0);
            }
        ...
        for (int feature = 0; feature < numNeurons1; feature++) {
            ...
            for (int n1 = 0; n1 < numNeurons2;n1++) {
                featureToLayer.add(rnd.nextDouble() * 0.01); //* Math.sqrt(2/(numNeurons1 + numNeurons2))); //todo weight init
                v2.add(0.0);
            }
        ...
        for (int feature = 0; feature < numNeurons2; feature++) {
            ...
            for (int n1 = 0; n1 < numNeurons3;n1++) {
                featureToLayer.add(rnd.nextDouble() * 0.01); //* Math.sqrt(2/(numNeurons3 + numNeurons2))); //todo weight init
                v2.add(0.0);
            }
    ...
    public static ArrayList<ArrayList<Double>> reLU(ArrayList<ArrayList<Double>> x) {
        ...
        for (int i =0; i < x.size(); i++) {
            ...
            for (int j = 0; j < x.get(i).size(); j++) {
                ...
                if (x.get(i).get(j) < 0) {val = Math.exp(x.get(i).get(j)) - 1;}
                current.add(val);
            }
            newX.add(current);
        }
        ...
        for (int row = 0; row < activation2.size(); row++) {
            ...
            for (int col = 0; col < activation2.get(row).size(); col++) {
                if (activation2.get(row).get(col) >=0) {
                    ...
                    double newValue = activation2.get(row).get(col) + 1;
                    currentDeriv.add(Math.log(newValue));
                }
            }
        ...
        for (int row = 0; row < activation1.size(); row++) {
            ...
            for (int col = 0; col < activation1.get(row).size(); col++) {
                if (activation1.get(row).get(col) >=0) {
                    ...
                    double newValue = activation1.get(row).get(col) + 1;
                    currentDeriv.add(Math.log(newValue));
                }
            }
    ...
    public static class DimensionalityReduction extends ELUMNIST {
