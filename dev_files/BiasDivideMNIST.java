...
public class BiasDivideMNIST  {
    ...
    public static int numData = 250; //forward and back pass would hapepn quick iwth 500, 100, 32, 16, 50, 0.0004
    ...
    public static void main(String[]args) throws Exception{
        ...
        for (int epoch = 0; epoch < numEpochs; epoch++) {
            ...
            if (Double.isNaN(grad1.get(0).get(0))) {
                break;
            }
    ...
    public static class DimensionalityReduction extends BiasDivideMNIST {
