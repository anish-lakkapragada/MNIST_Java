package MNIST_DNN.dev_files; /**
 - doesn't use momentum or NAG , so saved copy here
 **/
...
public class MNIST2500  {
    ...
    public static int numData = 2500; //forward and back pass would hapepn quick iwth 500, 100, 32, 16, 50, 0.0004
    ...
    public static double learningRate = 0.000005; //working 0.0001 with 200, 4, 2, 100, 1000 config
    public static double biasLearningRate = 0.00002 ;
    ...
    public static double gradClip = 5000;
    ...
    public static class DimensionalityReduction extends MNIST2500 {
